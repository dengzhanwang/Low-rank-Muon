...
optimizer1 = torch.optim.AdamW(adam_params, lr = 0.01, betas=(0.8, 0.95), eps=1e-10, fused=True)
...
model: nn.Module = torch.compile(model, options={"epilogue_fusion": True})  # 移除 fp8
########################################
#            Warmup kernels            #
########################################
